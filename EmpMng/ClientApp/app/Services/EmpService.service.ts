...
export class EmployeeService {
    ...
    getQualificationList() {
        return this._http.get(this.myAppUrl + 'api/Employee/GetQualificationList').map(res => res.json()).catch(this.errorHandler);
    }

    getExperienceList() {
        return this._http.get(this.myAppUrl + 'api/Employee/GetExperienceList').map(res => res.json()).catch(this.errorHandler);
    }

    getLanguageList() {
        return this._http.get(this.myAppUrl + 'api/Employee/GetLanguageList').map(res => res.json()).catch(this.errorHandler);
